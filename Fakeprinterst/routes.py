...
from Fakeprinterst import app, database, bcrypt
from Fakeprinterst.models import Usuario, Foto
from flask_login import login_required,login_user, logout_user, current_user
from Fakeprinterst.forms import FormLogin, FormCriarConta, FormFoto
import os
...
def feed():
    ...
    return render_template("feed.html",fotos=fotos, usuario=current_user)